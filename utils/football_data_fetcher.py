"""
Module pour récupérer les données de football réelles depuis l'API Football.
Ce module est utilisé dans l'onglet Surveillance en direct pour afficher des matchs en temps réel.
"""
import os
import requests
from datetime import datetime

def get_football_live_matches():
    """
    Récupère les matchs en direct depuis l'API Football.
    
    Returns:
        list: Liste des matchs en direct formatés pour l'interface utilisateur
    """
    try:
        ...
        for idx, fixture in enumerate(data.get('response', [])):
            ...
            # Formater le match pour l'interface
            match_data = {
                "id": idx + 1,
